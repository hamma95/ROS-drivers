...
######################################################
    ...
    #####################################################
        ...
        rospy.Subscriber("rwheel", Int16, self.wheelCallback) 
        rospy.Subscriber("rwheel_vtarget", Float32, self.targetCallback) 
        self.pub_motor = rospy.Publisher('rmotor_cmd',Float32, queue_size=10) 
        self.pub_vel = rospy.Publisher('rwheel_vel', Float32, queue_size=10)
